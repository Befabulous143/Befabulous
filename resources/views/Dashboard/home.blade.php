...
@section('content')
        <div class=" grid grid-cols-1  place-items-start lg:p-4 px-4 pb-2 py-16  w-auto h-auto g-6 text-gray-800">
            <div style="background-image: url({{ asset('images/banner_image.jpg') }})" class="grid banner-image shadow-xl grid-cols-1 w-full  p-4 lg:pr-10 lg:pl-10">
            ...
            <div class="grid  grid-cols-1 w-full   lg:pr-0 lg:pl-10">
                <div class="grid grid-cols-1">
                    <div class="grid  grid-cols-1 gap-4 place-items-end  pt-0 pb-2">
                        <a href="{{ route('point_history') }}" class="flex gap-1 px-10 py-3 shadow-md shadow-gray-400 rounded text-white app-bg-color" data-mdb-ripple="true"
                            data-mdb-ripple-color="light">
                            <div class="grid grid-cols-1 place-items-center">
                                <img style="filter: invert(100%) sepia(16%) saturate(7463%) hue-rotate(222deg) brightness(119%) contrast(115%);" class="w-5 h-5" src="{{ asset('images/transaction (1).png') }}" alt="">
                            </div>
                            Transactions
                        </a>
                    </div>
