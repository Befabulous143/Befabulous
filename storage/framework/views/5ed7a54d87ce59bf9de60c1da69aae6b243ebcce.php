...
<?php if(isset($coupons) && is_array($coupons) && $coupons != []): ?>
<?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="flex app-bg-color mt-4   w-full h-40 rounded-md py-2 shadow-md shadow-gray-400">
        <div class="flex items-center justify-center w-48  pl-3  ">
            <img src="<?php echo e(isset($coupon['standard_image_1']) && $coupon['standard_image_1'] !='' ? $coupon['standard_image_1'] : asset('images/undraw_gifts_0ceh.svg')); ?>"
                class="w-44 h-40 rounded" alt="Coupen_img" srcset="">
        </div>
        <div class="text-white w-52   px-3">
            <div class="flex flex-col justify-left">
                <h1 title="<?php echo e($coupon['series_name'] ?? ''); ?>"
                    ...
                    <?php echo e($coupon['series_name'] ?? ''); ?>

                </h1>
                <h2 class="text-md font-thin   ml-0.5" title="<?php echo e($coupon['standard_description'] ??''); ?>"
                    ...
                    <?php echo e($coupon['standard_description'] ?? ''); ?>
                ...
                <div class="bg-white  pt-1 px-3 lg:px-2  lg:w-44 md:px-1   text-center">
                    <div class="grid grid-cols-1 text-left">
                        <img src="data:image/png;base64,<?php echo e($base64); ?>" alt="Barcode">
                        <h1 style="font-size: 9px" class="text-gray-800  font-bold"><?php echo e($coupon['code'] ?? ''); ?> </h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php endif; ?>
</div><?php /**PATH C:\Users\manikuttan\Befabulous\resources\views/offers/index.blade.php ENDPATH**/ ?>