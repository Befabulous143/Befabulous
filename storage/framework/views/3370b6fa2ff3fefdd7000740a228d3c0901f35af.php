    ...
    <div class="grid  shadow-xl app-bg-color rounded grid-cols-1 w-full  p-4 lg:pr-10 lg:pl-10">
        <div class="grid grid-cols-1 place-items-center h-36" style="">
            ...
            <img class="w-56 h-56 rounded-full bg-gray-200	border-4 border-amber-600 p-2"
                src="<?php echo e($profile ?? asset('images/user-pic.png')); ?>" alt="">
        </div>
    </div>
</div>
    ...
    <div class="grid  grid-cols-1 w-full">
        <div class="grid grid-cols-1">
            <div class="grid lg:mt-0 sm:mt-2 mt-5  grid-cols-1 gap-4 place-items-center  pt-0 pb-0">
                <h2 class="lg:text-lg text-lg text-gray-700 font-semibold	"><?php echo e($data['firstname'] ?? ''); ?> <?php echo e($data['lastname'] ?? '-----'); ?></h2>
            </div>
            <div class="grid  grid-cols-1 gap-4 place-items-center  pt-0 pb-2">
                <h2 class="lg:text-lg text-lg text-gray-700 font-semibold	">(<?php echo e($data['email'] ?? ''); ?>)
                    <a href="<?php echo e(route('edit')); ?>"><i class="fa-solid fa-pen-to-square"></i> </a>
                </h2>
            </div>
        </div>
    </div>
...
<form action="<?php echo e(route('delete')); ?>" method="POST" class="hidden">
    <?php echo csrf_field(); ?>
    <button type="submit" id="closeAccount"></button>
</form>
<a href="<?php echo e(route('logout')); ?>" id="logOut" class="hidden"></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Befabulous\resources\views/Profile/index.blade.php ENDPATH**/ ?>