        ...
        <div class="grid grid-cols-1 place-items-center h-full g-6 text-gray-800">
            <div class="md:w-8/12 lg:w-5/12 mb-12 md:mb-0 bg-gray-100 rounded lg:p-16   p-10  w-full h-auto">
                <form action="<?php echo e(route('send-otp')); ?>" method="POST">
                    ...
                    <div class="mb-6">
                        <input value="<?php echo e('+'.$mobile ?? ''); ?>" minlength="8" maxlength="15" autocomplete="off" id="phone" type="text" name="mobile"
...
<?php echo $__env->make('layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Befabulous\resources\views/Auth/verify-mobile.blade.php ENDPATH**/ ?>